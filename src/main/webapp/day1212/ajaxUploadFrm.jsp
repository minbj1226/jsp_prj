		...
		$.ajax({
			...
			success: function(jsonObj) {
				if(jsonObj.resultFlag) {
					alert("이미지가 업로드되었습니다.");
					$("#profile").val(jsonObj.uplodaName);
				} else{
					alert("이미지 업로드 실패");
				}
			}
         ...
         <div class="row featurette">
            <div class="col-md-7">
            	...
            	enctype="multipart/form-data" binary 전송 방식
            	 -->
            	<form action="ajaxUploadFrmProcess.jsp" method="post" enctype="multipart/form-data" id="frm">
            	<label>업로더</label>
            	...
            	<br>
            	<label>파일</label><br>
            	<img src="http://localhost/jsp_prj/upload/default_img.png" id="preview" style="width: 100px; height: 100px; border-radius: 50px;"/>
            	...
            	<input type="button" value="정보입력" id="btnUpload" class="btn btn-success btn-sm"/>
            	</form>
            </div>
