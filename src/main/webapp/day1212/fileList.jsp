      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
            	...
            	<td><c:out value="${file.length}"></c:out></td>
            	...
            	if(urlName != null){
            		//파일명이 QueryString에 영향을 주는 문자열이 있다면 download.jsp로 보내지지 않으므로 encoding 해야한다
            		urlName=URLEncoder.encode(urlName, "UTF-8");
            	}
            	%>
            	<tr>
            	<td><%= i+1 %></td>
            	<td><a href="${CommonURL }/day1212/download.jsp?fileName=<%= file.getName() %>"><%= file.getName() %></a>
            	<td><%= file.getName() %></td>
