...
<li>요청 파라미터: <%= request.getParameter("nick") %></li>
<li>요청 파라미터: <%= request.getParameter("age") %></li>
...
%>
<br>
이름: <%= headerName %>, 값: <%= request.getHeaderNames() %>
<%
}
%>
</li>
...
<form method="post" action="useRequest.jsp?name" enctype="multipart/form-data">
