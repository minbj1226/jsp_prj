...
<!-- 공통디자인 외부 파일방식으로 사용 -->
<link rel="stylesheet" type="text/css" href="http://192.168.10.75/html_prj/common/css/main_v251031.css"/>
...
<div id="joinFrmDiv">
	...
	<table id="joinFrm">
		...
		<input type="button" value="Get 방식 값 전송" class="btnBox"
		onclick="getNameValue()" id="btnGet"/>
		</td>
		</tr>
	</table>
	</form>
	...
	<table id="joinFrm">
		...
		<td colspan="2" style="text-align: center">
		<input type="hidden" name="code" value="U3881">
		<input type="button" value="POST 방식 값 전송" class="btnBox"
		onclick="getNameValue()" id="btnPOST"/>
		</td>
		</tr>
	</table>
	</form>
