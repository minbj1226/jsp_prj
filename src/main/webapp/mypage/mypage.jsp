...
<link rel="shortcut icon"
	href="http://192.168.10.75/jsp_prj/common/images/favicon.ico">

<script src="http://192.168.10.75/jsp_prj/common/js/color-modes.js"></script>
<!-- bootstrap CDN 시작 -->
<link
...
<link href="http://192.168.10.75/jsp_prj/common/css/carousel.css"
	rel="stylesheet">
...
<script type="text/javascript">
	$(function() {
		   $("#btnUpload").click(function(){ //업로드 버튼을 누르면
				$("#upfile").click(); //파일을 선택하면 파일이 변경()
		   });
					...
					<form name="modifyFrm" method="post" id="modifyFrm"
						...
						<table id="joinFrm">
							...
							<tr>
            					...
            					<input type="button" value="업로드" id="btnUpload" class="btn btn-success btn-sm"/>
							...
							<tr>
								...
								<td class="input"><select id="loc" name="loc" class="inputBox"
