...
<title>JSP템플릿</title>
<link rel="shortcut icon" href="http://192.168.10.75/jsp/common/images/favicon.ico">
...
#calHeader{text-align:center; margin-bottom: 40px}
...
.weekTitle{width: 120px; text-align: center; font-style:normal}
...
.weekText{color:#000000}
.satText{color:#307DEF}

.toDayTd{background-color: #BACEE0}
</style>
<!-- jQuery CDN 시작 -->
  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div id="calWrap">
            <jsp:useBean id="cDTO" class="day1119.CalendarDTO"></jsp:useBean>
            ...
            String paramYear=cDTO.getNowYear();
            ...
            String paramMonth=cDTO.getNowMonth();
