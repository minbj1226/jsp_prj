  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            ...
            <c:if test="${i.first}">
            <tr>
            <td colspan="2">데이터를 출력하기 전 사용자에게 보여질 내용</td>
            </tr>
            </c:if>
            <tr>
            ...
            <c:if test="${i.last}">
            <tr>
            <td colspan="2">데이터가 출력된 후 마지막 내용</td>
            </tr>
            </c:if>
            </c:forEach>
            </tbody>
            ...
            //2. scope 객체에 데이터를 추가 => EL은 변수에 직접 접근 불가
            ...
            <c:if test="${i.last}">
            <tr>
            <td colspan="2">총 나이</td><td><c:out value="${totalAge}"/></td>
            </tr>
            </c:if>
            </c:forEach>
            </tbody>
