...
<link href="http://192.168.10.75/jsp_prj/common/css/carousel.css" rel="stylesheet">
...
function searchEmp(){
	...
	$.ajax({
		...
		success:function(jsonObj){
			...
			var createTr="";
			$("#tab > tbody").empty(); //tbody내의 모든 자식노드를 삭제
  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            ...
            pageContext.setAttribute("deptList", es.searchAllDept()); //데이터 베이스에서 조회한 것을 scope객체에 저장
            %>
            	...
            	<option value="${deptDTO.deptno}"><c:out value="${deptDTO.dname}"></c:out>
            	</c:forEach>
            	</select>
